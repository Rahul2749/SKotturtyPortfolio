    ...
    <section className="py-section-gap px-container-margin reveal" id="process">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-6">
          <div className="glass p-8 rounded-3xl text-center project-card">
            <span className="text-primary font-black text-2xl mb-4 block">01</span>
            <span className="text-label-sm text-white font-bold uppercase">Research</span>
          </div>
          <div className="glass p-8 rounded-3xl text-center project-card">
            <span className="text-secondary font-black text-2xl mb-4 block">02</span>
            <span className="text-label-sm text-white font-bold uppercase">Strategy</span>
          </div>
          <div className="glass p-8 rounded-3xl text-center project-card">
            <span className="text-tertiary font-black text-2xl mb-4 block">03</span>
            <span className="text-label-sm text-white font-bold uppercase">Wireframe</span>
          </div>
          <div className="glass p-8 rounded-3xl text-center project-card">
            <span className="text-primary font-black text-2xl mb-4 block">04</span>
            <span className="text-label-sm text-white font-bold uppercase">Design</span>
          </div>
          <div className="glass p-8 rounded-3xl text-center project-card">
            <span className="text-secondary font-black text-2xl mb-4 block">05</span>
            <span className="text-label-sm text-white font-bold uppercase">Branding</span>
          </div>
          <div className="glass p-8 rounded-3xl text-center project-card">
            <span className="text-tertiary font-black text-2xl mb-4 block">06</span>
            <span className="text-label-sm text-white font-bold uppercase">Marketing</span>
          </div>
          <div className="glass p-8 rounded-3xl text-center project-card">
            <span className="text-primary font-black text-2xl mb-4 block">07</span>
