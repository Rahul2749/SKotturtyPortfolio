    ...
    <section className="py-section-gap px-container-margin" id="process">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:grid md:grid-cols-4 lg:grid-cols-7 gap-6 pb-8 md:pb-0">
          <div className="process-step glass p-6 md:p-8 rounded-3xl text-center project-card w-[85%] self-start md:w-full">
          ...
          <div className="process-step glass p-6 md:p-8 rounded-3xl text-center project-card w-[85%] self-end md:w-full">
          ...
          <div className="process-step glass p-6 md:p-8 rounded-3xl text-center project-card w-[85%] self-center md:col-span-1 md:w-full">
