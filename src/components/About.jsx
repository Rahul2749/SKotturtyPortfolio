      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div className="space-y-6">
            <h2 className="about-heading font-headline-lg text-[26px] md:text-headline-lg text-white leading-tight">The <span className="italic font-light">Mind</span> Behind</h2>
