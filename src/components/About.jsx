export default function About() {
  return (
    <section className="py-section-gap px-container-margin reveal" id="about">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div className="space-y-6">
            <h2 className="font-headline-lg text-headline-lg text-white">The <span className="italic font-light">Mind</span> Behind</h2>
