  ...
  return (
    <section ref={sectionRef} className="min-h-[90vh] flex flex-col justify-center py-16 md:py-20 px-6 md:px-12 max-w-7xl mx-auto relative z-10" id="ads-stats">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        {/* Meta Ads Card */}
        <div className="glass rounded-[2.5rem] p-6 md:p-8 relative overflow-hidden ads-card border-t border-white/10 group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display-md text-white">Meta Ads</h3>
                <p className="text-xs text-on-surface-variant uppercase tracking-wider font-bold">Instagram & Facebook</p>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div className="glass-panel rounded-2xl p-5 bg-surface-container/30 border border-white/5">
                <p className="text-xs text-on-surface-variant mb-1">Avg. ROAS</p>
                <div className="text-3xl md:text-4xl font-display-md text-white count-up" data-value="450" data-suffix="%">0%</div>
              ...
              <div className="glass-panel rounded-2xl p-5 bg-surface-container/30 border border-white/5">
                ...
                <div className="text-3xl md:text-4xl font-display-md text-white count-up" data-value="12.5" data-suffix="M+">0M+</div>
              ...
              <div className="glass-panel rounded-2xl p-5 bg-surface-container/30 border border-white/5">
                ...
                <div className="text-3xl md:text-4xl font-display-md text-white count-up" data-value="3.8" data-suffix="%">0%</div>
              ...
              <div className="glass-panel rounded-2xl p-5 bg-surface-container/30 border border-white/5">
                ...
                <div className="text-3xl md:text-4xl font-display-md text-white count-up" data-value="85" data-suffix="K+">0K+</div>
        ...
        <div className="glass rounded-[2.5rem] p-6 md:p-8 relative overflow-hidden ads-card border-t border-white/10 group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display-md text-white">Google Ads</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="glass-panel rounded-2xl p-5 bg-surface-container/30 border border-white/5">
                ...
                <div className="text-3xl md:text-4xl font-display-md text-white count-up" data-value="12.4" data-suffix="%">0%</div>
              ...
              <div className="glass-panel rounded-2xl p-5 bg-surface-container/30 border border-white/5">
                ...
                <div className="text-3xl md:text-4xl font-display-md text-white count-up" data-value="40" data-prefix="-" data-suffix="%">0%</div>
              ...
              <div className="glass-panel rounded-2xl p-5 bg-surface-container/30 border border-white/5">
                ...
                <div className="text-3xl md:text-4xl font-display-md text-white count-up" data-value="5.2" data-suffix="M+">0M+</div>
              ...
              <div className="glass-panel rounded-2xl p-5 bg-surface-container/30 border border-white/5">
                ...
                <div className="text-3xl md:text-4xl font-display-md text-white count-up" data-value="320" data-suffix="%">0%</div>
