export default function Skills() {
  return (
    <section className="py-section-gap px-container-margin reveal">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-8">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <div className="px-6 py-2 glass rounded-full text-label-sm text-outline uppercase border border-white/5">Figma</div>
            <div className="px-6 py-2 glass rounded-full text-label-sm text-outline uppercase border border-white/5">Adobe CC</div>
            <div className="px-6 py-2 glass rounded-full text-label-sm text-outline uppercase border border-white/5">Webflow</div>
            <div className="px-6 py-2 glass rounded-full text-label-sm text-outline uppercase border border-white/5">After Effects</div>
          </div>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
          <div className="glass p-8 rounded-3xl flex flex-col items-center gap-4 group hover:bg-primary/10 transition-colors project-card">
          ...
          <div className="glass p-8 rounded-3xl flex flex-col items-center gap-4 group hover:bg-secondary/10 transition-colors project-card">
          ...
          <div className="glass p-8 rounded-3xl flex flex-col items-center gap-4 group hover:bg-tertiary/10 transition-colors project-card">
