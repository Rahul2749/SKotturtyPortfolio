    ...
    <section className="py-section-gap bg-[#edf0f6] relative" id="case-studies">
      ...
      <div className="max-w-7xl mx-auto px-container-margin relative z-10">
        <div className="case-header mb-16 flex flex-col items-center text-center md:items-start md:text-left">
          ...
          <h2 className="font-headline-lg text-[40px] md:text-[64px] text-on-surface mt-2 leading-[1.1]">Project <span className="italic font-normal">Strategies</span></h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="md:col-span-8 group relative bg-[#eaeff5] rounded-[2.5rem] p-8 md:p-12 border border-[#c4cdd9] hover:border-primary/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col shadow-2xl min-h-[400px]">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            {/* Oversized Background Number */}
            <div className="absolute -bottom-10 -right-10 text-[180px] font-black text-[#c4cdd9]/20 group-hover:text-primary/[0.05] transition-colors duration-700 pointer-events-none tracking-tighter">
              100%
            </div>
            ...
            <div className="relative z-10 flex-1 flex flex-col h-full justify-between">
              <div>
                <div className="flex justify-between items-start mb-8">
                  ...
                  <span className="text-[#64748b] text-label-sm font-semibold tracking-wide border border-[#c4cdd9] px-4 py-1 rounded-full glass">Premium UX</span>
                </div>
                <h3 className="text-3xl md:text-5xl font-bold text-[#1e293b] mb-6 leading-tight max-w-lg">Shape2Real: Immersive Architecture</h3>
                <p className="text-[#334155] font-medium leading-relaxed mb-10 text-lg md:text-xl font-normal max-w-xl">
          ...
          <div className="md:col-span-4 group relative bg-[#eaeff5] rounded-[2.5rem] p-8 md:p-10 border border-[#c4cdd9] hover:border-tertiary/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col shadow-2xl min-h-[400px]">
            ...
            <div className="relative z-10 flex-1 flex flex-col h-full">
              ...
              <p className="text-[#334155] font-medium leading-relaxed mb-8 text-base font-normal">
          ...
          <div className="md:col-span-5 group relative bg-[#eaeff5] rounded-[2.5rem] p-8 md:p-10 border border-[#c4cdd9] hover:border-secondary/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col shadow-2xl min-h-[400px]">
          ...
          <div className="md:col-span-7 group relative bg-[#eaeff5] rounded-[2.5rem] p-8 md:p-12 border border-[#c4cdd9] hover:border-[#4ade80]/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col shadow-2xl min-h-[400px]">
            ...
            {/* Oversized Background Number */}
            <div className="absolute -bottom-10 right-0 text-[180px] font-black text-[#c4cdd9]/20 group-hover:text-[#4ade80]/[0.05] transition-colors duration-700 pointer-events-none tracking-tighter">
              GenZ
            </div>
            ...
            <div className="relative z-10 flex-1 flex flex-col h-full justify-between">
              <div>
                <div className="flex justify-between items-start mb-8">
                  ...
                  <span className="text-[#64748b] text-label-sm font-semibold tracking-wide border border-[#c4cdd9] px-4 py-1 rounded-full glass">Wealth Management</span>
                </div>
                <h3 className="text-3xl md:text-5xl font-bold text-[#1e293b] mb-6 leading-tight max-w-lg">Future Investment Planner</h3>
                <p className="text-[#334155] font-medium leading-relaxed mb-10 text-lg font-normal max-w-xl">
