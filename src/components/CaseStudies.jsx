    ...
    <section className="py-section-gap bg-surface-container-low/30 relative" id="case-studies">
      ...
      <div className="max-w-7xl mx-auto px-container-margin relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-8 mt-auto">
                <div className="grid grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="text-sm text-white/90 font-medium">Static portfolios.</p>
                  </div>
                  <div>
                    <span className="block text-[10px] text-outline uppercase font-black mb-1 tracking-widest">Strategy</span>
                    <p className="text-sm text-white/90 font-medium">Scroll animation.</p>
                  </div>
                  <div>
                ...
                <a className="inline-flex items-center justify-center w-14 h-14 rounded-full border border-white/10 group-hover:border-primary/40 group-hover:bg-primary text-white transition-all shrink-0" href="https://shape2-real-web.vercel.app/" target="_blank" rel="noreferrer">
          ...
          {/* CARD 2: FinTech App (Narrow - 4 Cols) */}
          <div className="md:col-span-4 group relative bg-[#131620] rounded-[2.5rem] p-8 md:p-10 border border-white/5 hover:border-tertiary/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col shadow-2xl min-h-[400px]">
            ...
            <div className="relative z-10 flex-1 flex flex-col h-full">
              <span className="text-tertiary font-bold text-[10px] tracking-widest uppercase mb-6 inline-block w-fit border border-tertiary/20 bg-tertiary/5 px-4 py-1.5 rounded-full">UI/UX App Case Study</span>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">FinTech App: Next-Gen Banking</h3>
              <p className="text-on-surface-variant leading-relaxed mb-8 text-base font-light">
                Designing a modern banking dashboard and intuitive user flows to simplify complex financial data.
              </p>
              
              <div className="mt-auto space-y-4">
                <div className="flex justify-between items-center pb-3 border-b border-white/5">
                  <span className="text-[10px] text-outline uppercase font-black tracking-widest">Problem</span>
                  <span className="text-sm text-white/90">Cluttered data.</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-white/5">
                  <span className="text-[10px] text-outline uppercase font-black tracking-widest">Result</span>
                  <span className="text-sm text-tertiary font-bold">Streamlined flows.</span>
                </div>
                <div className="pt-4 flex justify-between items-center">
                   <span className="text-sm text-white font-bold tracking-wide">View UI Screens</span>
            ...
            <div className="relative z-10 flex-1 flex flex-col h-full">
              ...
              <div className="mt-auto space-y-4">
                 <div className="flex justify-between items-center pb-3 border-b border-white/5">
                  ...
                  <span className="text-sm text-white/90">Botanical Niche.</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-white/5">
                ...
                <a href="https://adeniumheaven.in/" target="_blank" rel="noreferrer" className="pt-4 flex justify-between items-center cursor-pointer group">
                   <span className="text-sm text-white font-bold tracking-wide">Visit Live Store</span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-8 mt-auto">
                <div className="grid grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="text-sm text-white/90 font-medium">Youth engagement.</p>
                  </div>
                  <div>
                    <span className="block text-[10px] text-outline uppercase font-black mb-1 tracking-widest">Strategy</span>
                    <p className="text-sm text-white/90 font-medium">Interactive Data.</p>
                  </div>
                  <div>
                    <span className="block text-[10px] text-outline uppercase font-black mb-1 tracking-widest">Result</span>
                ...
                <a className="inline-flex items-center justify-center w-14 h-14 rounded-full border border-white/10 group-hover:border-[#4ade80]/40 group-hover:bg-[#4ade80] group-hover:text-black text-white transition-all shrink-0" href="https://future-investment-planner-iink.vercel.app/" target="_blank" rel="noreferrer">
                  <span className="material-symbols-outlined text-[24px] group-hover:-rotate-45 transition-transform duration-300">arrow_forward</span>
                </a>
              </div>
            </div>
